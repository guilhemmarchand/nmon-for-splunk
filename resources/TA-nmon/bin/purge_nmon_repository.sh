...
# Clean various dir
NMON_REPO=${SPL_HOME}/etc/apps/${APP}/var/nmon_repository
CONFIG_REPO=${SPL_HOME}/etc/apps/${APP}/var/config_repository
CSV_REPO=${SPL_HOME}/etc/apps/${APP}/var/csv_repository
SPOOL=${SPL_HOME}/etc/apps/${APP}/var/spool
TEMP=${SPL_HOME}/etc/apps/${APP}/var/nmon_temp
