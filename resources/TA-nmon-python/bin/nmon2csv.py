...
# APP Directories for standard nmon, TA-nmon-python-python, PA-nmon
if is_windows:
...
if is_windows:
    TA_NMON_APP = SPLUNK_HOME + '\\etc\\apps\\TA-nmon-python-python'
else:
    TA_NMON_APP = SPLUNK_HOME + '/etc/apps/TA-nmon-python-python'
...
if os.path.exists(NMON_APP):
    ...
    msg = 'The Application root directory could not be found, is nmon / TA-nmon-python-python / PA-nmon installed ? We tried: ' + str(
